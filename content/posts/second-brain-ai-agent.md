---
title: "Second Brain: Cara AI Agent Ingat Semua Tanpa Batas 🧠"
date: 2026-08-06T11:15:00+07:00
draft: false
...
1. **Buat folder** `brain/` dengan subfolder: `RAW/`, `wiki/`, `blog/`, `riset/`
2. **Taruh sumber asli** di `RAW/` (artikel, transkrip, PDF)
3. **Minta AI meringkas** sumber tadi ke `wiki/` per topik
4. **Buat `INDEX.md`** — katalog semua isi (biar AI tahu apa yang ada)
5. **Tulis `AGENT.md`** — aturan: "RAW = kebenaran, jangan diubah; wiki = ringkasan yang kamu tulis"
